              ...
              <div class='row-fluid'>
                <div class='span12 box bordered-box green-border' style='margin-bottom:0;'>
                  <div class='box-header green-background'>
                    <div class='title'>幻灯片查看</div>
                    <div class='actions'>
						<a href="${fmreq.contextPath}/slide/edit.nuskin?sid=${obj.id}" class="btn btn-default">编辑</a>
						<a href="javascript:void(0);" class="sldrm btn btn-default" sid="${obj.id}">删除</a>
                    </div>
                  </div>
                        ...
                        <table class='table table-bordered table-hover table-striped' style='margin-bottom:0;table-layout:fixed;' id="listtable">
                          <tbody>
							<tr>
								...
								<td style="width:30%"><img src="${fmreq.contextPath}/slide/${obj.picture!}" width="240px" height="180px" /></td>
								<td style="width:20%">外链地址</td>
								<td style="width:30%"><a href="${obj.outlink}">${obj.outlink}</a></td>
							</tr>
                          </tbody>
                        </table>
                      </div>
